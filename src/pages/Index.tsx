          ...
          {features.map((feature, index) => {
            ...
            return (
              <button
                ...
                className="bg-white/80 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-6 w-full md:w-64 mx-auto text-center space-y-3 hover:scale-105"
              >
