                        ...
                        <div className="space-y-5">
                            ...
                            <section className="rounded-2xl border border-zinc-200 bg-white p-5 text-slate-800 shadow-sm">
                              <header className="space-y-1">
                                <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-slate-500">
                                  Beskrivning enligt Systembolaget
                                </p>
                                <p className="text-xs text-slate-500">
                                  Sammanfattar karaktär och smak från Systembolagets text.
                                </p>
                              </header>
                              <div className="mt-4 space-y-4 text-sm text-slate-700">
                                {descriptionBlocks.map((block) => (
                                  <div key={block.label} className="space-y-1">
                                    ...
                                    <p className="leading-relaxed text-slate-700">{block.value}</p>
                                  </div>
                                ))}
                              </div>
                            </section>
                          ...
                          <section className="rounded-2xl border border-zinc-200 bg-white p-5 text-slate-800 shadow-sm">
                            <header className="space-y-1">
                              ...
                              <p className="text-xs text-slate-500">Rekommenderad servering från Systembolaget.</p>
                            </header>
                        ...
                        <div className="space-y-5">
                          <section className="rounded-2xl border border-zinc-200 bg-white p-5 text-slate-800 shadow-sm">
                            <header className="space-y-1">
                              ...
                              <p className="text-xs text-slate-500">Skala 0–5, direkt från Systembolagets mätare.</p>
                            </header>
                            <div className="mt-4 grid grid-cols-3 gap-4">
                              {tasteProfile.meters.map((meter) => (
                                <div key={meter.label} className="flex flex-col items-center gap-2 text-slate-700">
                                  <GaugeCircleSB label={meter.label} value={meter.value ?? null} size={64} stroke={6} showValue />
                            ...
                            {!hasTasteData && (
                              <p className="mt-4 text-xs text-amber-600">
                                Systembolaget har inte publicerat mätvärden för denna flaska.
                              </p>
                            )}
                          </section>
